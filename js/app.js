          ...
          const startGame = () => {
            const engine = {
              ...
              update: () => {
                ...
                engine.balls.forEach(b=>{b.inQuzheDomain=false;if(b.baseMaxHp===undefined)b.baseMaxHp=b.maxHp;if(b.erodedMaxHp===undefined)b.erodedMaxHp=0;if(b.portalCooldown>0)b.portalCooldown-=DT;});
